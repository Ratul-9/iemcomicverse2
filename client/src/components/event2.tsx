    ...
    <>
      <style>{`
        ...
        * {
        ...
        /* FIX: Ensure content inside p tag is visible */
        .speech-bubble p {
            white-space: normal; /* This is the key fix */
            word-wrap: break-word; /* Added for extra safety on long words */
        }
        .anime-card:hover .speech-bubble {
            animation: slide-up 1s ease-out forwards;
        }
...
.speech-bubble {
  ...
  /* FIX: Ensure content inside p tag is visible in media queries */
  .speech-bubble p {
      white-space: normal;
      word-wrap: break-word;
  }
          ...
          <div className="anime-card anime-card-1">
            <div className="card-inner">
              ...
              <div className="speech-bubble">
                  ...
                  Grey quotient is an engaging quiz contest that dives into the vibrant worlds of comics and anime.<br/>
                   Participants test their knowledge on a wide range of topics, from iconic superheroes to beloved anime characters,
                    fostering a friendly competition. It's a thrilling event for fans to celebrate their passion and showcase their expertise.
                </p>
              </div>
            </div>
          </div>
