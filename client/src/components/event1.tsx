...
import logo from '../assets/logo.png';
import { Link } from 'wouter';
// Re-added unused imports that were in your provided code,
// though they are not used in this specific component.
// If they are truly unused, they can be removed in a larger project context.
import Home from "@/components/Navbar";
import Navbar from "@/components/Navbar";
import HeroSection from "@/components/HeroSection";
import EventsSection from "@/components/EventsSection";
...
.hero {
  ...
  overflow: hidden;
    ...
    .event-title {
      ...
      letter-spacing: 12px;
      animation: pulse 2s infinite, color-cycle 10s infinite;
      word-wrap: break-word; /* Ensures text wraps on smaller screens */
    }
    ...
    .section {
      ...
      margin: 0 auto;
      position: relative;
      overflow: hidden; /* Added to contain potential overflow from scaled cards */
    }
    ...
    .event-container {
      display: grid;
      /* FIX: Use minmax to allow cards to shrink on larger screens to prevent overflow */
      ...
      width: 100%;
      box-sizing: border-box;
      margin: 0 auto; /* Centered the event container */
    }

    .anime-card {
      width: 100%; /* Allow card to take full width of its grid cell */
      max-width: 500px; /* Limit max width for very large screens */
      height: 500px;
      position: relative;
      cursor: pointer;
      transition: all 0.4s cubic-bezier(0.175, 0.885, 0.32, 1.275);
 ...
 .anime-card:hover .card-inner {
  ...
  transition: background 0.3s ease-in-out;
    ...
    .anime-card:hover .speech-bubble {
      ...
      background-color: transparent; /* Ensure it's transparent on hover as well */
    }
    ...
    <div className="comicverse-container">
      ...
      <section className="section events">
        ...
        <div className="event-container">
          <div className="anime-card anime-card-1">
            <div className="card-inner">
              {/* NOTE: Content is intentionally left empty here as per your instruction.
                  The h3 itself will still appear and bounce on hover due to CSS. */}
              <h3 className="anime-card-title"></h3>
              <div className="speech-bubble">
                <p style={{ 
                  fontFamily: "'Bropella', sans-serif", 
