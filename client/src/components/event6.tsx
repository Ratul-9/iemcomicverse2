...
const ComicFest2025: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-900 text-gray-800 overflow-x-hidden">
      <style >{`
      ...
      <section className="section events">
        ...
        <div className="event-container">
          {[
            {
              id: 1,
              description: "A captivating showcase of digital art inspired by anime and comics!"
            },
            {
              id: 2,
              description: "Showcase your creativity and shine in the comic and manga world!"
            },
            {
              id: 3,
              description: "A short film-making contest showcasing storytelling evolution through the vibrant theme of comics."
            },
            {
              id: 4,
              description: "Unleash your creativity with vibrant strokes and comic-inspired art!"
            },
            {
              id: 5,
              description: "Vibrant live graffiti creation infused with the spirit of comics!"
            },
            {
              id: 6,
              description: "Using Gen-Ai to create dynamic comics and evolve with each stage!"
            }
          ].map((event) => (
            <div key={event.id} className={`anime-card anime-card-${event.id}`}>
