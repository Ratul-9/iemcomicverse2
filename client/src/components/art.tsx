...
const ComicFest2025: React.FC = () => {
  return (
    <>
      <Head>
        <title>Art - ComicFest 2025</title>
        <link
        ...
        <style>{`
          ...
          * {
          ...
          .anime-card-1 .card-inner {
            background: url('ani.png') no-repeat center center/cover;
          }
          .anime-card-2 .card-inner {
            background: url('ani1.png') no-repeat center center/cover;
          }
          .anime-card-3 .card-inner {
            background: url('ani2.png') no-repeat center center/cover;
          }
          .anime-card-4 .card-inner {
            background: url('ani3.png') no-repeat center center/cover;
          }
          .anime-card-5 .card-inner {
            background: url('ani4.png') no-repeat center center/cover;
          }
          .anime-card-6 .card-inner {
            background: url('ani5.png') no-repeat center center/cover;
          }
          .anime-card:hover .card-inner {
            background: url('art2.png') no-repeat center center/cover;
      ...
      <header>
        <img src="logo.png" alt="ComicVerse 2025 Logo" className="header-logo" />
      </header>
